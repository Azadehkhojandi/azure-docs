...
1. In the [Azure portal](https://portal.azure.com), search for and select the name of the Azure Purview instance that you created as a prerequisite and select *Open Purview Studio*. You're automatically taken to your Purview Studio's home page.
